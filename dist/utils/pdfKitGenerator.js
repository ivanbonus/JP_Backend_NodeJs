...
exports.generarCotizacionPdfKit = generarCotizacionPdfKit;
exports.generarGuiaPdfKit = generarGuiaPdfKit;
exports.generarBoletaPdfKit = generarBoletaPdfKit;
...
function generarCotizacionPdfKit(data) {
    return new Promise((resolve, reject) => {
        try {
            ...
            const drawCondRow = (label, value, y) => {
...
function generarGuiaPdfKit(data) {
...
function generarBoletaPdfKit(data) {
    return new Promise((resolve, reject) => {
        try {
            ...
            const drawTotalRow = (label, val, y, bold = false) => {
